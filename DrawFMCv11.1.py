...
def main():
	...
	print ("dibujado el arco inferior")
	...
	print ("este es la X del punto final lado1 del troncoCono:", pxd)
	print ("este es la Y del punto final lado1 del troncoCono:", pyd)
	#drawLineColoured(drawing,centroX, centroY, pxd, pyd, colorLine2)
	#print ("cono interno dibujado")
	px0a,py0a = damePtoArcoReloj(centroX,centroY,anguloIni,altura)
	print ("este es la X del punto final lado1 del troncoCono:", px0a)
	print ("este es la Y del punto final lado1 del troncoCono:", py0a)
	drawLineColoured(drawing, px0, py0, px0a,  py0a, colorLine3)
	pxda,pyda = damePtoArcoReloj(centroX,centroY,anguloFin,altura)
	print ("este es la X del punto final lado1 del troncoCono:", pxda)
	print ("este es la Y del punto final lado1 del troncoCono:", pyda)
